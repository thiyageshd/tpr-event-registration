...
export class RegistrationComponent {
  ...
  onSubmit(){
    ...
    this.requestProfile.phone_number=String(this.registrationForm.get("contactNumber")?.value);
    ...
    this.requestProfile.emergency_contact_number=String(this.registrationForm.get("emergencyContactNumber")?.value);
    this.requestProfile.terms_and_condition=this.registrationForm.get("termsAndCondition")?.value;
    this.registerService.registerUser(this.requestProfile).subscribe( {
      next:(res)=>{
